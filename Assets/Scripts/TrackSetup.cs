...
public class TrackSetup : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (track == 1 || hsScript.currentState == 0)
        {
            ChangeSetupState();
        ...
        else if (track == 0 || hsScript.currentState == 1)
        {
            ChangeSetupState();
    ...
    {
        if (hsScript.currentState == 0 && !fastModeOn)
        {
            fastModeOn = true;
            crossHair.SetActive(true);
        ...
        else if (hsScript.currentState == 1 && fastModeOn)
        {
            fastModeOn = false;
            crossHair.SetActive(false);
            foreach (GameObject reward in rewards)
